 ...
 * y el criterio de ordenamiento activo. Se oculta si no hay resultados o está cargando.
 */
const meta = {
...
/** Con resultados: muestra conteo y orden actual */
export const WithResults: Story = {
  decorators: [
    withStore({ products: MOCK_PRODUCTS, selectedBrand: ALL, selectedStore: ALL, isLoading: false, sortBy: "price_asc" }),
  ],
};
...
export const SingleResult: Story = {
  decorators: [
    withStore({ products: [MOCK_PRODUCTS[0]], selectedBrand: ALL, selectedStore: ALL, isLoading: false, sortBy: "price_asc" }),
  ],
};
...
export const SortedByPriceDesc: Story = {
  decorators: [
    withStore({ products: MOCK_PRODUCTS, selectedBrand: ALL, selectedStore: ALL, isLoading: false, sortBy: "price_desc" }),
  ],
};
...
export const NoResults: Story = {
  decorators: [
    withStore({ products: [], selectedBrand: ALL, selectedStore: ALL, isLoading: false }),
  ],
};
...
export const Loading: Story = {
  decorators: [
    withStore({ products: [], selectedBrand: ALL, selectedStore: ALL, isLoading: true }),
  ],
};
